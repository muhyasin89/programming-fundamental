...
(function dartProgram() {
  ...
  E = {
    main: function() {
      var tiger, t1, output, rover, t2,
        _s59_ = "kungfu panda said Grrr and weighs 600lbs\nkungfu panda runs\n";
      $.Animal_numberOfAnimals = $.Animal_numberOfAnimals + 1;
      tiger = new E.Animal();
      tiger.Animal$three$3("Saber", "Rowr", 550);
      t1 = document;
      t1.querySelector("#output").textContent = _s59_;
      output = _s59_ + (tiger.name + " said " + tiger.sound + " and weighs " + tiger._weight + "lbs\n") + ("Number of Animals : " + C.JSInt_methods.toString$0($.Animal_numberOfAnimals) + "\n");
      rover = new E.Dog();
      t2 = $.Animal_numberOfAnimals + 1;
      $.Animal_numberOfAnimals = t2;
      rover.name = "Rover";
      rover.sound = "Woof";
      rover._weight = 85;
      $.Animal_numberOfAnimals = t2 + 1;
      output = output + "Rover said Woof and weighs 85lbs\n" + (rover.super$Animal$info() + " and bites\n") + "Rectangle Area: 50\n Circle Area: 78.53981633974483\nRect2 Area 125\nSuperman flies faster than speeding bullet\n";
  ...
  E.Animal.prototype = {
    Animal$three$3: function($name, sound, weight) {
      this.name = $name;
      this.sound = sound;
      this._weight = weight;
      $.Animal_numberOfAnimals = $.Animal_numberOfAnimals + 1;
    ...
    info$0: function() {
      return this.name + ", " + this.sound + ", " + this._weight;
    }
  };
  E.Dog.prototype = {};
  (function aliases() {
    ...
    _ = E.Animal.prototype;
    _.super$Animal$info = _.info$0;
  })();
  (function inheritance() {
    var _inherit = hunkHelpers.inherit,
      _inheritMany = hunkHelpers.inheritMany;
    _inherit(P.Object, null);
    _inheritMany(P.Object, [H.JS_CONST, J.Interceptor, J.ArrayIterator, H.Closure, P.Error, P.bool, P.num, P.List, P.Null, P.String, P.StringBuffer, E.Animal]);
...
//# sourceMappingURL=classtut.js.map
